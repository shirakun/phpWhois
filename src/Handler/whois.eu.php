...
class eu_handler
{
    public function parse($data, $query)
    {
        ...
        $r['regrinfo'] = Parser::get_blocks($data['rawdata'], $items);
        ...
        if (isset($r['regrinfo']['tech'])) {
            $r['regrinfo']['tech'] = Parser::get_contact($r['regrinfo']['tech'], $extra);
        }

        if (isset($r['regrinfo']['domain']['registrar'])) {
            $r['regrinfo']['domain']['registrar'] = Parser::get_contact($r['regrinfo']['domain']['registrar'], $extra);
        }
